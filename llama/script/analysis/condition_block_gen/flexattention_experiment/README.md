...
python -m llama.script.analysis.condition_block_gen.flexattention_experiment.condition_block_flex_stage_latency \
  --device cuda:0 \
...
```bash
python llama/script/analysis/condition_block_gen/flexattention_experiment/summarize_condition_block_flex_stage_latency.py \
