...
Wraps analysis.condition_block_ppl.runner_cond_block, replacing only the condition computation in
...
Run from llama, e.g.:
  python -m script.analysis.condition_block_ppl.condition_bound.ppl_bennett \
...
from analysis.condition_block_ppl.runner_cond_block import _gather_prefix
