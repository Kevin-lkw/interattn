...
run_method \
  script.analysis.condition_block_ppl.multisample.run_attention_topk \
  attention_topk

run_method \
  script.analysis.condition_block_ppl.multisample.run_condition_block \
  condition_block

run_method \
  script.analysis.condition_block_ppl.multisample.run_h2o \
  h2o

run_method \
  script.analysis.condition_block_ppl.multisample.run_streamllm \
  streamllm

run_method \
  script.analysis.condition_block_ppl.multisample.run_quest \
  quest
