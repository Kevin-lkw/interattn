...
Scripts in this folder are run as plain files, e.g.

    python llama/script/analysis/condition_bound/hybrid_guarantee.py --device cuda:0
...
def parse_args(description, default_layers=(10, 15, 20)):
    ...
    from analysis import condition_block_corr as cbc
