...
def parse_args():
    parser = add_common_args(
        argparse.ArgumentParser(description="Run StreamLLM sink+recent baseline on many samples.")
    )
    parser.add_argument(
        "--budgets",
        type=float,
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="StreamLLM defaults to compressing every layer.",
    )
